<x-app-layout>
    ...
    <div class="container">
        ...
        <div class="flex justify-center mb-4">
            <select id="statusDropdown" onchange="sortTable()"
                class="px-4 py-2 bg-gray-200 text-gray-700 rounded focus:outline-none focus:ring-2 focus:ring-gray-300">
        ...
        <div class="overflow-hidden rounded-lg border border-gray-200 shadow-md m-5">
            <table class="w-full border-collapse bg-white text-left text-sm text-gray-500" id="applicationTable">
                ...
                <tbody class="divide-y divide-gray-100 border-t border-gray-100" id="applicationTableBody">
                    @php
                        $no = 1;
                    @endphp
                    @foreach ($applications as $application)
                        ...
                        <!-- Approve Modal -->
                        <div class="modal fade" id="approveApplication{{ $application->id }}" tabindex="-1" role="dialog"
                                        ...
                                        <div class="modal-body">
                                            <div class="row align-items-center my-3">
                                                <div class="col-md-12" style="font-size:14pt;">
                                                    ...
                                                    <input type="text" class="userType" name="userType"
                                                        value="{{$application->User_type}}" hidden>
                                                    <input type="text" class="id" name="id"
                                                        value="{{$application->application_ID}}" hidden>
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <!-- Reject Modal -->
                        <div class="modal fade" id="rejectApplication{{ $application->id }}" tabindex="-1" role="dialog"
                            aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog  modal-dialog-centered">
                                <div class="modal-content">
    ...
    <script>
        function sortTable() {
            ...
            let rows = document.querySelectorAll("#applicationTableBody tr");
            rows.forEach(row => {
                let rowStatus = row.querySelector("td:nth-child(7) span").innerText.toUpperCase();
                if (status === "" || (status === "Pending" && rowStatus === "PENDING") ||
